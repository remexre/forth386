...
idt_init:
	...
	write pic1_cmd,  0x11 ; Initializing, expect 3 more "init words" on the data port.
	...
	write pic2_cmd,  0x11 ; Initializing, expect 3 more "init words" on the data port.
...
; Sets an IDT entry. Expects the interrupt number in eax, and the handler address in ecx. Trashes
; ecx.
global idt_set
idt_set:
