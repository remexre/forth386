...
: hexdump-write-row ( addr -- )
  ...
  $10 0 do space dup i + c@ hexdump-write-byte loop
  space $b3 emit space
...
: hexdump ( addr -- )
  ...
  $10 0 do space space dup i + hexdump-write-nybble loop
  space $b3 emit space
  $10 0 do dup i + hexdump-write-nybble loop
  space $b3 emit cr
  ...
  $80 0 do dup i + hexdump-write-row $10 +loop
  drop
